...
$auth_users = array(
    'admin' => '$2y$10$uWld9YA.Eq4XLGeHJ1l2m.4FqmwxWNraEMbKiNiYF9aaSLGMKmC.u', 
    'user' => '$2y$10$uWld9YA.Eq4XLGeHJ1l2m.4FqmwxWNraEMbKiNiYF9aaSLGMKmC.u'
    ...
    <div class="path">
        ...
        <ul class="folders break-word">
            ...
            foreach ($folders as $f) {
                ?>
                <li>
                    <a href="?p=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>&amp;copy=<?php echo urlencode($copy) ?>"><i class="fa fa-home"></i> <?php echo fm_convert_win($f) ?></a></li>
                <?php
            }
            ?>
        </ul>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            echo '<div class="col-xs-6 col-sm-5">' . $editFile . '</div>';
            ?>
            ...
            <div class="col-xs-6 col-sm-7 text-right">
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    ...
                    <?php if (!FM_READONLY): ?>
                    <li class="nav-item">
                        <a title="<?php echo lng('Upload') ?>" class="nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;upload"><i class="fa fa-cloud-upload" aria-hidden="true"></i> <?php echo lng('') ?></a>
                    </li>
                    <li class="nav-item">
                        <a title="<?php echo lng('NewItem') ?>" class="nav-link" href="#createNewItem" data-toggle="modal" data-target="#createNewItem"><i class="fa fa-plus-square"></i> <?php echo lng('') ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if (FM_USE_AUTH): ?>
                    <?php else: ?>
                        <?php if (!FM_READONLY): ?>
                            <li class="nav-item">
                                <a title="<?php echo lng('Settings') ?>" class="dropdown-item nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;settings=1"><i class="fa fa-cog" aria-hidden="true"></i> <?php echo lng('') ?></a>
                            </li>
                            <li class="nav-item">
                                <a title="<?php echo lng('Log Out') ?>" class="dropdown-item nav-link" href="logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo lng('') ?></a>
                            </li>
                        <?php endif; ?>
                    <?php endif; ?>
                </ul>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Tiny File Manager';      $tr['en']['AppTitle']           = 'Disk root';
